...
//test	
	...
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_YAW		, 1200);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_THROTTLE	, 1300);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_AUX1		, 1400);	//arm
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_AUX2		, 1300);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_AUX3		, 1200);
