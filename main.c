...
//	PCA9685_pwmWrite(NAZE32_BARO	, NAZE32_BARO_OFF);
	PCA9685_pwmWrite(NAZE32_ROLL	, 100);
	PCA9685_pwmWrite(NAZE32_PITCH	, 200);
	PCA9685_pwmWrite(NAZE32_YAW		, 300);
	PCA9685_pwmWrite(NAZE32_THROTTLE, 400);
	PCA9685_pwmWrite(NAZE32_ARM		, 500);
