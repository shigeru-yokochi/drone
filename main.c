...
//test	
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_ROLL		, 900);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_PITCH	, 1000);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_YAW		, 1100);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_THROTTLE	, 1200);
