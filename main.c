...
//test	
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_ROLL		, 800);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_PITCH	, 900);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_YAW		, 1000);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_THROTTLE	, 1100);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_AUX1		, 1200);	//arm
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_AUX2		, 1100);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_AUX3		, 1000);
