...
//	PCA9685_pwmWrite(NAZE32_BARO	, NAZE32_BARO_OFF);
	PCA9685_pwmWrite(NAZE32_ROLL	, 1100);
	PCA9685_pwmWrite(NAZE32_PITCH	, 1200);
	PCA9685_pwmWrite(NAZE32_YAW		, 1300);
	PCA9685_pwmWrite(NAZE32_THROTTLE, 1400);
	PCA9685_pwmWrite(NAZE32_ARM		, 1500);
	PCA9685_pwmWrite(NAZE32_BARO	, 1900);
	sleep(1);
	sleep(5);
...
//	PCA9685_pwmWrite(NAZE32_BARO, NAZE32_BARO_OFF);
	...
	PCA9685_pwmWrite(NAZE32_PITCH	, 1000);
	PCA9685_pwmWrite(NAZE32_YAW		, 1000);
	PCA9685_pwmWrite(NAZE32_THROTTLE, 1000);  //aux1
	PCA9685_pwmWrite(NAZE32_ARM		, 1000);
	PCA9685_pwmWrite(NAZE32_BARO	, 1000); //aux3
	sleep(1);
	sleep(5);
