...
#define BETAFPV_F4_2S_AIO_YAW		2
#define BETAFPV_F4_2S_AIO_THROTTLE	3
...
//	double dfPower[4];		//pwm1..4の個別用出力調整値
	...
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_ROLL		, BETAFPV_F4_2S_AIO_NEUTRAL+100);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_PITCH	, BETAFPV_F4_2S_AIO_NEUTRAL+200);
	PCA9685_pwmWrite(BETAFPV_F4_2S_AIO_YAW		, BETAFPV_F4_2S_AIO_NEUTRAL+300);
